...
$PAGE->requires->js(new moodle_url('https://cdn.datatables.net/1.13.6/js/jquery.dataTables.min.js'));
$PAGE->requires->js(new moodle_url('https://cdn.datatables.net/select/3.1.3/js/dataTables.select.min'));
